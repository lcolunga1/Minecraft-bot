...
export function createMinecraftBot({ logger, brain, reputation }) {
  ...
  // chat entrante: comportamiento -> reputación + invocación
  bot.on("chat", async (username, message) => {
    ...
    // responder cuando lo ocupen (invocación o necesidad)
  ...
  // PvP defensivo: si el bot recibe daño, decide con IA
  ...
  bot.on("error", (err) => logger.log({ type: "bot_error", error: String(err) }));
